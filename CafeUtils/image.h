...
struct Image
{
    ...
    /**
     * \brief Parse given data to an image — detects ELF vs RPX automatically
...
// Plain ELF (used for testing / debug)
Image ElfLoadImage(const uint8_t* data, size_t size);

// Wii U RPX/RPL — ELF with zlib-compressed sections + RPX-specific flags
