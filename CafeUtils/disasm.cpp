...
// CafeRecomp: Espresso is a PPC750-class CPU (big-endian).
// "750" selects the PPC750/G3 ISA variant in the binutils disassembler.
thread_local ppc::DisassemblerEngine ppc::gBigEndianDisassembler{ BFD_ENDIAN_BIG, "750" };
